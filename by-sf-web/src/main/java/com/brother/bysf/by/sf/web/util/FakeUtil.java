...
public class FakeUtil {
    ...
    public static String getHobby(){
        return hobby[new Random().nextInt(hobby.length)];
    }

    public static String getName(){
        return surname[new Random().nextInt(surname.length)] + getChinese();
    }
    ...
    private static String[] address = {"青羊区","锦江区","金牛区","武侯区","成华区","龙泉驿区","青白江区","新都区","温江区","都江堰市","彭州市","邛崃市","崇州市","金堂县","郫县","新津县","双流县","蒲江县","大邑县"};

    private static String[] hobby = {"吃火锅", "打麻将", "写代码"};
